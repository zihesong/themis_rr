...
def run_monkey(apk, avd_serial, avd_name, output_dir, testing_time, screen_option, login_script, snapshot, monkey_seed):
    command = 'bash -x run_monkey.sh %s %s %s %s %s %s %s %s %d' % (apk, avd_serial, avd_name,
                                                              output_dir,
                                                              testing_time,
                                                              screen_option,
                                                              login_script, 
...
def run_ape(apk, avd_serial, avd_name, output_dir, testing_time, screen_option, login_script, snapshot):
...
def run_combodroid(apk, avd_serial, avd_name, output_dir, testing_time, screen_option, login_script, snapshot):
    command = 'bash -x run_combodroid.sh %s %s %s %s %s %s %s %s' % (apk, avd_serial, avd_name,
                                                                  output_dir,
                                                                  testing_time,
                                                                  screen_option,
                                                                  login_script,
...
def run_humanoid(apk, avd_serial, avd_name, output_dir, testing_time, screen_option, login_script, snapshot):
    command = 'bash -x run_humanoid.sh %s %s %s %s %s %s %s %s' % (apk, avd_serial, avd_name,
                                                                  output_dir,
                                                                  testing_time,
                                                                  screen_option,
                                                                  login_script,
...
def run_stoat(apk, avd_serial, avd_name, output_dir, testing_time, screen_option, login_script, snapshot):
...
def run_sapienz(apk, avd_serial, avd_name, output_dir, testing_time, screen_option, login_script, snapshot):
...
if __name__ == '__main__':
    ...
    ap.add_argument('--seed', type=int, default=0, dest='monkey_seed', help="seed of monkey")
    ap.add_argument('--snapshot', type=str, default='snap_2022-04-20_10-31-54', dest='snapshot', help="snapshot of emulator")
